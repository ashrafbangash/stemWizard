    ...
    return (
        <div className='main bg-redish '>
            <div className="sub mb-10 relative">
                ...
                <img src="./assets/events/ico4.svg" alt="icon" className='absolute hidden lg:block -top-20 left-1/2' />
                <img src="./assets/events/ico5.svg" alt="icon" className='absolute hidden lg:block bottom-0 left-1/4' />
                <img src="./assets/events/ico6.svg" alt="icon" className='absolute hidden lg:block bottom-0 right-20' />
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-20 items-center ">
                    <form className="">

                        <h1 className='text-2xl lg:text-[40px]  font-medium capitalize '>Join Our Competitions</h1>
                        <img src="./assets/underline.svg " className='max-w-[243px] mb-10  ' alt="underline" />
                        <h1 className='text-xl lg:text-[28px] my-4'>Attend Our Hackathones</h1>
