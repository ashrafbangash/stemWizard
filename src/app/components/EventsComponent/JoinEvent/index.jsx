...
<img src="./assets/events/ico4.svg" alt="icon" className='absolute -top-20 left-1/2' />
<img src="./assets/events/ico5.svg" alt="icon" className='absolute bottom-0 left-1/4' />
<img src="./assets/events/ico6.svg" alt="icon" className='absolute bottom-0 right-20' />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center ">
        <form className="">

        <h1 className='text-[40px]  font-medium capitalize '>Join Our Competitions</h1>
        <img src="./assets/underline.svg " className='max-w-[243px] mb-10  ' alt="underline" />
        <h1 className='text-[28px] my-4'>Attend Our Hackathones</h1>
