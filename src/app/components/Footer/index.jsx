...
const Footer = ({bgColor}) => {
  return (
    <div className={` ${bgColor} items-center mt-44 md:mt-20 relative h-full `}>
                ...
                <div className="flex  justify-between items-center flex-wrap absolute -top-24  md:top-0 lg:top-[65%] h-fit  -translate-y-1/2 z-20   px-5 md:px-16 lg:px-20  w-full max-w-screen-max-screen">
