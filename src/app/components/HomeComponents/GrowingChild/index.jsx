...
const GrowingChild = () => {
    const sections = [
        ...
        },
        {
            ...
            description: 'Technology offers opportunities for active learning of STEM concepts as well as scientific reasoning.', 
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2  xl:grid-cols-4 gap-10'>
                        {sections.map((section, index) => (
                            <div key={index} className='relative'>
                                <img className='max-w-xs h-auto scale-90 md:scale-100' src={section.img1Src} alt="growingChild"  />
                                <img className='max-w-[270px] absolute top-4 left-6 h-auto scale-90 md:scale-100' src={section.img2Src} alt="growingChild" />
                                <div className={`absolute ${section.class} text-center px-10`}>
                                    <h1 className='text-[20px] md:text-[28px] font-medium'>{section.title}</h1>
