            ...
            <div className='main-div bg-white'>
                <div className='md:sub-div items-center relative'>
                    ...
                    <div className='relative'>
                        <img src="./assets/contact/contact.svg" alt="contact" className="hidden lg:block scale-110 xl:scale-100" />
                        <img src="./assets/contact/mconbg.svg" alt="contact" className="lg:hidden w-full block  object-cover" />
                        ...
                        <div className=" lg:col-span1">
                            <h1 className="text-2xl font-semibold mb-3 lg:mb-5">Toronto:</h1>
                            <p className="text-base font-medium mb-3 lg:mb-5">Toronto: 41 Northumberland St Toronto, ON M6H 1R2, Canada</p>
                            <h1 className="text-2xl font-semibold  mb-3 lg:mb-5">Pakistan:</h1>
                            <p className="text-base font-medium">Paistan: I21/3, Kaghan House street near Alnoor Masjid, Iqbal Road, Supply Abbottabad</p>
                        </div>
                        </div>
                    </div>

                    <img src="./assets/contact/contacticon.svg" alt="icon" className="absolute hidden lg:block bottom-0 right-20 z-20" />
                </div>
