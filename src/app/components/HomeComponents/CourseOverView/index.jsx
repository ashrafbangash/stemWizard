...
const CourseOverView = () => {
    ...
    return (
        <div className='w-full flex flex-col justify-center items-center pb-6 sm:pb-10 md:pb-14   bg-orangish lg:bg-white'>
            ...
            <img src="./assets/home/rocket.svg" alt="bg" className='  z-20 hidden lg:block  absolute top-0 left-1/2 ' />
            <img src="./assets/home/space-roc.svg" alt="bg" className='  z-20 hidden lg:block  absolute bottom-0  left-[16%]' />
            <img src="./assets/home/mars1.svg" alt="bg" className='  z-20  hidden lg:block absolute top-0 left-3/4 h-[120px] w-[120px] ' />
            </div>
