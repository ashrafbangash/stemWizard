        ...
        <div className='main bg-redish'>
            <div className='sub items-center relative '>
                ...
                <div className='bg-redish flex mt-20 justify-center flex-col items-center h-full  max-h-[575px] '>
                    <div className='relative'>
                        <img className='max-w-4xl w-full  absolute top-0  z-0 left-[48%] -translate-x-1/2 ' src="./assets/abouthero/abborder.svg" alt="about" />
                        <img className='max-w-4xl w-full  relative  z-20' src="./assets/abouthero/abimg.png" alt="about" />
                        <img className='max-w-4xl w-full  absolute top-0 z-0 left-[52%] -translate-x-1/2 ' src="./assets/abouthero/abbg.svg" alt="about" />
                    </div>
                    <p className='text-base mb-8 max-w-4xl text-center mt-8'>Stem Wizards Academia has been providing continuing STEM Education for both schools and individuals in Pakistan. The purpose of our organization is to improve the world of the future and to promote individual well-being through enhanced learning, knowledge-sharing, and sustainable development.</p>
