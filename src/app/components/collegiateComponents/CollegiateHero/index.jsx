  ...
  return (
    ...
    <div className='sub items-center relative '>
        <div className='relative overflow-hidden sm:overflow-visible'>
            <h1 className='text-2xl md:text-[40px] mb-3 text-center font-medium uppercase'>Collegiate Program</h1>
            <img src="./assets/underline.svg " className='max-w-[193px] mx-auto  mb-6' alt="underline" />
