        ...
        <>
            <div className='main-div bg-white'>
                <div className='sub-div items-center relative'>
                    <h1 className='text-2xl lg:text-[40px] text-center font-medium'>Admission</h1>
                    ...
                    <img src="./assets/contact/contact.svg" alt="contact" className="hidden lg:block scale-110 xl:scale-100" />
                        <img src="./assets/contact/mconbg.svg" alt="contact" className="lg:hidden w-full block scale-105  object-cover" />
                        ...
                        <div className="absolute top-1/2 -translate-y-1/2 w-full  xl:px-32 p-4">
                            <form className="">
                                ...
                                <button className='bg-green mx-auto lg:mx-0 py-3 px-10 flex items-center gap-2 w-fit rounded-xl text-white mt-'>Submit <FiArrowRight /></button>
