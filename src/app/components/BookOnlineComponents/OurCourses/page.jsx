    ...
    return (
        <div className='main'>
            <div className="sub items-center relative">
                <h1 className='text-2xl md:text-[40px] font-medium '>Courses</h1>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2  xl:grid-cols-3 2xl:grid-cols-4 gap-10'>
                    {sections.map((section, index) => (
                        <div key={index} className='relative'>
                            <img className='max-w-4xl w-full  absolute top-0  z-0 left-[48%] -translate-x-1/2 ' src="./assets/bookonline/bg.svg" alt="about" />
                            <img className='max-w-4xl w-full  relative  z-20' src="./assets/bookonline/green.svg" alt="about" />
                            <img className='max-w-4xl w-full  absolute top-0 z-0 left-[52%] -translate-x-1/2 ' src="./assets/bookonline/border.svg" alt="about" />
                            <div className="absolute top-0 lg:top-3 lg:left-6 z-20">
                                <img src="/assets/bookonline/1.svg" alt="one" className='scale-90 ' />
                                <h1 className='text-xl lg:text-[28px] font-medium leading-6 px-6  '>{section.title}</h1>
                                <p className=' px-6 text-xs lg:text-base'>Start Date   End Date</p>
                                <Link href={`/bookonline/${section.id}`}><button className='bg-white py-3 mx-6 px-6 flex items-center gap-2 w-fit rounded-xl mt-1 text-green'>{section.btnTitle} <FiArrowRight /></button></Link>
