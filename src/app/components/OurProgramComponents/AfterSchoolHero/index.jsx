...
const AfterSchoolHero = () => {
  return (
    <div className='main bg-gray'>
        ...
        <h1 className='text-[40px] text-center font-medium uppercase '>after-school program</h1>
            
            <img src="./assets/underline.svg " className='max-w-[193px] mb-10' alt="underline" />

            <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                <div className="flex flex-col text-base gap-10">
                    ...
                    <p>STEM Wizards Academia After School Program also provides access to the latest technology and tools, such as 3D printers and virtual reality equipment, to provide students with a hands-on learning experience that prepares them for the future. Overall, STEM Wizards Academia After School Program offers a fun and engaging learning environment that empowers students to become confident, curious, and competent in STEM, setting them up for success in their future academic and professional endeavors.</p>
                </div>
            ...
            <img src="./assets/ourprogram/ico3.svg" alt="icons" className='absolute right-[50%] -bottom-[0%] z-10' />
        <img src="./assets/ourprogram/ico4.svg" alt="icons" className='absolute right-[5%] top-[20%]' />
        <img src="./assets/ourprogram/ico1.svg" alt="icons" className='absolute left-[10%] top-[10%]' />
